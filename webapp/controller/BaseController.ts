...
export default abstract class BaseController extends Controller {
	...
	/**
		 ...
		 */
	public getBundleTextByModel(sI18nKey: string, oResourceModel: any, aPlaceholderValues: string[]): void {
		return oResourceModel.getResourceBundle().then(function (oBundle: any) {
